...
BEGIN TRANSACTION
    INSERT INTO sales VALUES
        (11, 'Adam',   'IT',    '2023-01-01', 1000),
        (12, 'Kunal',   'HR',    '2023-01-05', 5500),
        (13, 'Yash',   'IT',    '2023-01-10', 2500)

    BEGIN TRANSACTION
        INSERT INTO sales VALUES
            (14, 'Rohini',   'IT',    '2023-01-01', 1900),
            (15, 'Chetan',   'IT',    '2023-01-05', 6700),
            (16, 'Ajay',   'IT',    '2023-01-10', 7800)
    COMMIT TRANSACTION
COMMIT TRANSACTION
...
BEGIN TRANSACTION
    INSERT INTO sales VALUES
        (17, 'Adam',   'IT',    '2023-01-01', 1000),
        (18, 'Kunal',   'HR',    '2023-01-05', 5500)

    BEGIN TRANSACTION
        INSERT INTO sales VALUES
            (19, 'Rohini',   'IT',    '2023-01-01', 1900),
            (20, 'Chetan',   'IT',    '2023-01-05', 6700)
            PRINT @@TRANCOUNT
...
-- PROCEDURE FOR INSERTING IN MULTIPLE TABLES USING TRANSACTIONS
...
EXEC sp_process_sale @sale_id = 11
